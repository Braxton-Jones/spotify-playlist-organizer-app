...
import { getUserInfo, getUserPlaylists, getUserSavedTracks, getUserTopItems} from "../../api_endpoints";
...
const [isOpen, setIsOpen] = useState(false)
    ...
    <Suspense fallback={<p>Loading Saved Tracks...</p>}>
        ...
        <motion.img src={userInfo.images[0].url} className="dashboard-profile_img"/>
            
                        <motion.div
                            className="dashboard-user_info"
                        >
        ...
        <section className="playlists-section">
            ...
            <Suspense fallback={<p>Loading...</p>}>
                <Await
                    ...
                    errorElement={<p>Error getting the playlists...</p>}
                    >
                        {(playlists)=>(
        ...
        <PlaylistModalPortal open={isOpen} onClose={() => setIsOpen(false)} selectedPlaylistID={``}>
            Hmmmmm
        </PlaylistModalPortal>
    </section>
